...
const { parseUnits, formatUnits } = ethers_1.utils;
exports.toWad = (amount, decimals = 18) => {
    return parseUnits(exports.sanitizeDecimals(amount, decimals), decimals);
};
exports.fromWad = (wad, decimals = 18) => {
    return exports.sanitizeDecimals(formatUnits(wad, decimals), decimals);
};
