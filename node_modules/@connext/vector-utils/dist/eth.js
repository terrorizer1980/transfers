...
const minGasPrice = ethers_1.BigNumber.from(1000);
exports.getEthProvider = (providerUrl, chainId) => new ethers_1.providers.JsonRpcProvider(providerUrl, classicProviders.includes(providerUrl) || classicChainIds.includes(chainId) ? "classic" : undefined);
...
exports.hydrateProviders = (chainProviders) => {
    ...
    Object.entries(chainProviders).map(([chainId, url]) => {
        hydratedProviders[chainId] = new ethers_1.providers.JsonRpcProvider(url);
    });
