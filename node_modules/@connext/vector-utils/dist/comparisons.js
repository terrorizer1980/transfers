...
exports.notGreaterThan = (value, ceil) => {
    ...
    return ethers_1.BigNumber.from(value).gt(ethers_1.BigNumber.from(ceil))
        ? undefined
...
exports.notGreaterThanOrEqualTo = (value, ceil) => {
    ...
    return ethers_1.BigNumber.from(value).gte(ceil)
        ? undefined
...
exports.notLessThan = (value, floor) => {
    ...
    return ethers_1.BigNumber.from(value).lt(floor)
        ? undefined
...
exports.notLessThanOrEqualTo = (value, floor) => {
    ...
    return ethers_1.BigNumber.from(value).lte(floor)
        ? undefined
