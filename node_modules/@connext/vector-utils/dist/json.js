...
function bigNumberifyJson(json) {
    return typeof json === "string"
        ? json
        : JSON.parse(JSON.stringify(json), (key, value) => (value && value._hex && value._isBigNumber) ? bigNumbers_1.toBN(value._hex)
            : (value && value.hex && value.type === "BigNumber") ? bigNumbers_1.toBN(value.hex)
                : value);
}
