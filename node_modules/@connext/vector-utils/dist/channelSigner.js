...
class ChannelSigner extends ethers_1.Signer {
    ...
    connectProvider(provider) {
        return __awaiter(this, void 0, void 0, function* () {
            this.provider =
                typeof provider === "string" ? new ethers_1.providers.JsonRpcProvider(provider, yield chainId_1.getChainId(provider)) : provider;
        });
    }
    connect(provider) {
    ...
    signTransaction(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const wallet = new ethers_1.Wallet(this.privateKey, this.provider);
