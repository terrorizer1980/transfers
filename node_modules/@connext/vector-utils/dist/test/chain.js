...
exports.createTestTxResponse = (overrides = {}) => {
    ...
    return Object.assign({ hash,
        to,
        from, data: util_1.mkHash(), value: ethers_1.BigNumber.from(10), chainId: 1, nonce: 43, gasLimit: ethers_1.BigNumber.from(123576), gasPrice: ethers_1.BigNumber.from(1657639), timestamp: Date.now(), raw: util_1.mkHash(), blockHash,
...
exports.createTestTxReceipt = (overrides = {}) => {
    return Object.assign({ transactionHash: util_1.mkHash("0xaecb"), to: util_1.mkAddress("0x1111"), from: util_1.mkAddress("0x2222"), blockHash: util_1.mkHash("0xbbbbb"), blockNumber: 487, contractAddress: util_1.mkAddress("0xcccc"), transactionIndex: 3, root: util_1.mkHash(), gasUsed: ethers_1.BigNumber.from(1657639), logsBloom: "logs", logs: [], cumulativeGasUsed: ethers_1.BigNumber.from(1657639), byzantium: true, confirmations: 15 }, overrides);
};
