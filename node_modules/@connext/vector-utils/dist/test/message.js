...
exports.createVectorMessage = exports.createVectorErrorMessage = exports.createVectorChannelMessage = void 0;
...
function createVectorChannelMessage(overrides = {}) {
    ...
    return Object.assign({ to: util_1.mkPublicIdentifier("indraBBB"), from: util_1.mkPublicIdentifier("indraAAA"), inbox: "test_inbox", data: {
...
function createVectorErrorMessage(overrides = {}) {
    return Object.assign({ to: util_1.mkPublicIdentifier("indraBBB"), from: util_1.mkPublicIdentifier("indraAAA"), inbox: "test_inbox", error: new vector_types_1.InboundChannelUpdateError(vector_types_1.InboundChannelUpdateError.reasons.BadUpdateType, channel_1.createTestChannelUpdate("setup")) }, overrides);
}
exports.createVectorErrorMessage = createVectorErrorMessage;
function createVectorMessage(type = "channel", overrides) {
    if (type === "channel") {
        return createVectorChannelMessage(overrides);
    }
    return createVectorErrorMessage(overrides);
}
exports.createVectorMessage = createVectorMessage;
