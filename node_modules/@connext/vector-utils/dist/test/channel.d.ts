import { UpdateType, ChannelUpdate, ChannelUpdateDetailsMap, FullChannelState, UpdateParams, UpdateParamsMap, NetworkContext, IChannelSigner } from "@connext/vector-types";
...
export declare function createTestChannelState<T extends UpdateType = typeof UpdateType.setup>(type: T, overrides?: PartialFullChannelState<T>): FullChannelState<T>;
export declare function createTestChannelStateWithSigners<T extends UpdateType = typeof UpdateType.setup>(signers: IChannelSigner[], type: T, overrides?: PartialFullChannelState<T>): FullChannelState<T>;
