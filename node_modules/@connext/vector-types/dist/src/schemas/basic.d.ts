import { TStringLiteral } from "@sinclair/typebox";
...
export declare const TBasicMeta: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").UserDefinedOptions>;
...
export declare const TransferStateSchema: import("@sinclair/typebox").UserDefinedOptions;
export declare const TransferResolverSchema: import("@sinclair/typebox").UserDefinedOptions;
...
export declare const TChannelUpdateType: import("@sinclair/typebox").TUnion<[TStringLiteral<"create" | "deposit" | "resolve" | "setup">]>;
